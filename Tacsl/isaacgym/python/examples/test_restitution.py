...
args = gymutil.parse_arguments(
    description="Balls-ground restitution test")
...
restitution_delta = 1.0 / float(num_envs - 1)
for i in range(num_envs):
    ...
    print("Default restitution: ", shape_props[0].restitution)
    ...
    shape_props[0].restitution = restitution_delta * float(i)
    print("Number of shapes: ", len(shape_props))
    print(i, shape_props[0].restitution)
...
gym.viewer_camera_look_at(viewer, None, gymapi.Vec3(10, mid, 5), gymapi.Vec3(0, mid, 1))
    ...
    for evt in gym.query_viewer_action_events(viewer):
        if evt.action == "reset" and evt.value > 0:
            ...
            for i in range(num_envs):
                ...
                print(shape_props[0].restitution)

                # alternating between 0.0 and 1.0 restitution
                shape_props[0].restitution = float(reset_count % 3) / 2.0
