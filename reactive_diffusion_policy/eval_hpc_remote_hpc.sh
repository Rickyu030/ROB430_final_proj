...
python serve_latent_policy_ws.py \
  ...
  at=at_liftbottle \
  at_load_dir="/nfs/turbo/coe-vkamat/reactive_diffusion_policy/data/outputs/2026.02.19/12.44.26_train_vae_real_liftbottle_image_gelsight_emb_at_24fps_0219124423/checkpoints/latest.ckpt" \
  +ckpt_path="/nfs/turbo/coe-vkamat/reactive_diffusion_policy/data/outputs/2026.02.19/14.05.32_train_latent_diffusion_unet_image_real_liftbottle_image_gelsight_emb_ldp_24fps_0219124423/checkpoints/latest.ckpt"\
  +ws_host=0.0.0.0 \
  +ws_port=8765 \
  +serve_device=cuda:0 \
